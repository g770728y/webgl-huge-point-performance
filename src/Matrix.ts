...
export class Matrix
{
     ...
     */
    apply(pos: {x:number, y:number}, newPos?: {x:number,y:number}): {x:number,y:number}
    {
     ...
     */
    applyInverse<P extends {x:number,y:number}>(pos: P, newPos?: P): P
    {
        newPos = (newPos || {x:0, y: 0}) as P;
